...
export class ProductExtrasService {
  ...
  private reviewPool: Review[] = [
    ...
    { id: 11, author: 'Nisha J.', avatar: 'https://i.pravatar.cc/60?img=11', rating: 5, date: 'Feb 2, 2026', text: 'I order from VivaPetals for every special occasion — never once disappointed!', photos: ['https://images.unsplash.com/photo-1561181286-d3fee7d55364?w=200&q=80'], verified: true },
