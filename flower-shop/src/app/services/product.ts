...
export class ProductService {
  private products: Product[] = [
    { id: 1, name: 'Red Rose Bouquet', description: 'A stunning arrangement of 12 premium red roses, perfect for expressing love and romance.', price: 49.99, image: 'https://res.cloudinary.com/duf4t01vy/image/upload/v1771819102/ChatGPT_Image_Feb_22_2026_10_57_56_PM_nxsgri.png', category: 'Garlands', inStock: true, rating: 4.8 },
    { id: 2, name: 'Sunflower Delight', description: 'Bright and cheerful sunflowers that bring warmth and happiness to any space.', price: 34.99, image: 'https://res.cloudinary.com/duf4t01vy/image/upload/v1771818621/ChatGPT_Image_Feb_22_2026_10_49_55_PM_zopiuw.png', category: 'Garlands', inStock: true, rating: 4.6 },
    ...
    { id: 5, name: 'Pink Peony Paradise', description: 'Lush pink peonies that exude romance and charm.', price: 64.99, image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400', category: 'Flowers', inStock: true, rating: 4.9 },
    { id: 6, name: 'Orchid Elegance', description: 'Exotic orchids that add a touch of luxury to any setting.', price: 79.99, image: 'https://images.unsplash.com/photo-1566873535350-a3f5d4a804b7?w=400', category: 'Flowers', inStock: true, rating: 4.8 },
    { id: 7, name: 'Lavender Dreams', description: 'Fragrant lavender bundles perfect for relaxation and home decor.', price: 29.99, image: 'https://images.unsplash.com/photo-1468327768560-75b778cbb551?w=400', category: 'Flowers', inStock: true, rating: 4.5 },
    { id: 8, name: 'Tropical Paradise', description: 'Exotic tropical flowers including birds of paradise and hibiscus.', price: 69.99, image: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?w=400', category: 'Flowers', inStock: true, rating: 4.7 },
    { id: 9, name: 'White Rose Serenity', description: 'Pure white roses symbolizing peace, purity, and new beginnings.', price: 44.99, image: 'https://images.unsplash.com/photo-1559563362-c667ba5f5480?w=400', category: 'Bouquets', inStock: true, rating: 4.8 },
    { id: 10, name: 'Tulip Festival', description: 'Vibrant tulips in assorted colors celebrating the beauty of spring.', price: 36.99, image: 'https://images.unsplash.com/photo-1520763185298-1b434c919102?w=400', category: 'Flowers', inStock: true, rating: 4.6 },
    { id: 11, name: 'Carnation Charm', description: 'Long-lasting carnations in beautiful shades of pink and red.', price: 27.99, image: 'https://images.unsplash.com/photo-1526047932273-341f2a7631f9?w=400', category: 'Flowers', inStock: true, rating: 4.4 },
    { id: 12, name: 'Premium Flower Box', description: 'Luxury arrangement in an elegant gift box, perfect for special occasions.', price: 89.99, image: 'https://images.unsplash.com/photo-1561181286-d3fee7d55364?w=400', category: 'Flower Braids', inStock: true, rating: 5.0 },
    { id: 13, name: 'Yellow Rose Sunshine', description: 'Bright yellow roses representing friendship and joy.', price: 42.99, image: 'https://images.unsplash.com/photo-1455659817273-f96807779a8a?w=400', category: 'Flowers', inStock: true, rating: 4.7 },
    { id: 14, name: 'Daisy Meadow', description: 'Fresh white daisies bringing simplicity and charm.', price: 24.99, image: 'https://images.unsplash.com/photo-1606041008023-472dfb5e530f?w=400', category: 'Flowers', inStock: true, rating: 4.5 },
    { id: 15, name: 'Hydrangea Heaven', description: 'Beautiful blue hydrangeas perfect for home decoration.', price: 52.99, image: 'https://images.unsplash.com/photo-1468327768560-75b778cbb551?w=400', category: 'Flowers', inStock: true, rating: 4.8 },
    { id: 16, name: 'Cherry Blossom Branch', description: 'Delicate cherry blossoms symbolizing renewal and hope.', price: 47.99, image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400', category: 'Bouquets', inStock: true, rating: 4.9 },
    { id: 17, name: 'Gerbera Fiesta', description: 'Colorful gerbera daisies bringing vibrant energy to any room.', price: 32.99, image: 'https://images.unsplash.com/photo-1487530811176-3780de880c2d?w=400', category: 'Flowers', inStock: true, rating: 4.6 },
    { id: 18, name: 'Calla Lily Grace', description: 'Elegant calla lilies for sophisticated arrangements.', price: 58.99, image: 'https://images.unsplash.com/photo-1606041008023-472dfb5e530f?w=400', category: 'Flowers', inStock: true, rating: 4.8 },
    { id: 19, name: 'Wildflower Mix', description: 'Natural wildflower bouquet with rustic charm.', price: 35.99, image: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?w=400', category: 'Bouquets', inStock: true, rating: 4.5 },
    { id: 20, name: 'Ranunculus Delight', description: 'Layered ranunculus blooms in soft pastel colors.', price: 45.99, image: 'https://images.unsplash.com/photo-1518882605630-8eb920bc4c49?w=400', category: 'Flowers', inStock: true, rating: 4.7 },
    { id: 21, name: 'Purple Iris Elegance', description: 'Stunning purple irises with elegant form.', price: 38.99, image: 'https://images.unsplash.com/photo-1566873535350-a3f5d4a804b7?w=400', category: 'Flowers', inStock: true, rating: 4.6 },
    { id: 22, name: 'Protea Exotic', description: 'Unique South African protea flowers.', price: 72.99, image: 'https://images.unsplash.com/photo-1508610048659-a06b669e3321?w=400', category: 'Flowers', inStock: true, rating: 4.9 },
    { id: 23, name: 'Dahlia Dreams', description: 'Gorgeous dahlias in rich autumn colors.', price: 48.99, image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400', category: 'Flowers', inStock: true, rating: 4.7 },
    { id: 24, name: 'Anemone Beauty', description: 'Delicate anemones with striking dark centers.', price: 41.99, image: 'https://images.unsplash.com/photo-1518882605630-8eb920bc4c49?w=400', category: 'Flowers', inStock: true, rating: 4.6 },
    { id: 25, name: 'Chrysanthemum Burst', description: 'Full chrysanthemum blooms in various colors.', price: 33.99, image: 'https://images.unsplash.com/photo-1487530811176-3780de880c2d?w=400', category: 'Garlands', inStock: true, rating: 4.5 },
    { id: 26, name: 'Freesia Fragrance', description: 'Sweetly scented freesias in soft hues.', price: 36.99, image: 'https://images.unsplash.com/photo-1606041008023-472dfb5e530f?w=400', category: 'Flowers', inStock: true, rating: 4.7 },
    { id: 27, name: 'Amaryllis Red', description: 'Bold red amaryllis for dramatic displays.', price: 55.99, image: 'https://images.unsplash.com/photo-1518882605630-8eb920bc4c49?w=400', category: 'Flowers', inStock: true, rating: 4.8 },
